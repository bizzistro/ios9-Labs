...
class ViewController: UIViewController {
    ...
    //: let's create some constants for our colors
    //: Greens scheme
    ...
    @IBAction func changeSchemesButtonTapped(sender: UIButton) {
        ...
        screenTitleLabel.text = "Scheme Change"
        
        view.backgroundColor = teal
        
        screenLabel.textColor = white
        screenLabel.backgroundColor = purple
        screenLabel.text = "We have a color scheme change! This means we'll have to repaint the whole ship again!"
    }
